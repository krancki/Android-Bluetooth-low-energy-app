...
public class Connect {
    ...
    //  Created callback for connections
    ...
    // Select device which  you want to connect
    ...
    static String getCategory(int number) {
        ...
        switch (number) {
            ...
            case 768:
                ...
                break;
            case 769:
                text = "Thermometer: Ear";
                break;
            case 832:
                text = "Generic Heart rate Sensor";
                break;
            case 833:
                text = "Heart Rate Sensor: Heart Rate Belt";
                break;
            case 896:
                text = "Generic Blood Pressure";
                break;
            case 897:
                text = "Blood Pressure: Arm";
                break;
            case 898:
                text = "Blood Pressure: Wrist";
                break;
            case 960:
            ...
            case 1088:
                ...
                break;
            case 1089:
                text = "Running Walking Sensor: In-Shoe";
                break;
            case 1090:
                text = "Running Walking Sensor: On-Shoe";
                break;
            case 1091:
                text = "Running Walking Sensor: On-Hip";
                break;
            case 1152:
                text = "Generic: Cycling";
                break;
            case 1153:
                text = "Cycling: Cycling Computer";
                break;
            case 1154:
                text = "Cycling: Speed Sensor";
                break;
            case 1155:
