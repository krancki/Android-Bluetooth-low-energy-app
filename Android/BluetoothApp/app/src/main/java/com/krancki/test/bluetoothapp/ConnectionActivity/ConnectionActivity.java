...
public class ConnectionActivity extends AppCompatActivity {
    ...
    HashMap<String,EditText> fieldMap = new HashMap<>();
    ...
    @Override
        protected void onCreate(Bundle savedInstanceState) {
            ...
            connectionController.addActionListenerForSendBtn(sendBtn);
     ...
     //
        ...
        // Creating Message  and sending to handlers (Only call view thread)
